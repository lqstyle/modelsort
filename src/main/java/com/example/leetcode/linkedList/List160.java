 ...
 * //
 * // Related Topics 哈希表 链表 双指针 👍 2342 👎 0
 * <p>
 * <p>
...
public class List160 {
    ...
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        while (tmpANode != tmpBNode) {
            tmpANode = tmpANode != null ? tmpANode.next : headB;
            tmpBNode = tmpBNode != null ? tmpBNode.next : headA;
        }
